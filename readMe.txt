...
glove.6B.50d.txt is the wordVector txt file which is used to make the word vectors. It is taken from this link : https://nlp.stanford.edu/projects/glove/
...
classification_gridsearch.py is the main file that does all the training ,grid search and plots the graphs.It generates 3 txt files
